...
onlyOwner
internal returns(ROUX_Crowdsale)
{
  //should ony be able to call this ONE time!
  mToken = new ROUX_Token();
  mCrowdsale =  new ROUX_Crowdsale(_startTime, _endTime, _initialRate, _finalRate, _cap, mEscrowWallet, mToken);
...
// =================================================================================================================
  ...
  internal
  {
      ...
      //Calculate royalty amount based on ROUX balance in shareholders wallet
  }
